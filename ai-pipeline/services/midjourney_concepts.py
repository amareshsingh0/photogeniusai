...
CANONICAL SOURCE: this file. Synced copies for deployment:
- aws/lambda/generation/midjourney_concepts.py (Lambda)
- apps/api/app/services/midjourney_concepts.py (FastAPI)
"""
