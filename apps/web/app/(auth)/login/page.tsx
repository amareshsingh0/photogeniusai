    ...
    <div className="min-h-screen grid place-items-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="glass-panel rounded-3xl p-8">
          <p className="kerned text-center text-white/40">Welcome back</p>
          <h1 className="mt-2 text-center font-display text-3xl">Sign in</h1>
          <p className="mt-2 text-center text-sm text-white/60">Continue to your studio.</p>
          ...
          <form onSubmit={handleSubmit} className="mt-7 space-y-4">
            ...
            <label className="block">
              <div className="mb-1.5 flex items-center justify-between">
                <span className="kerned text-white/50">Password</span>
