...
export const metadata = {
  title: "Terms of Service | PhotoGenius AI",
  description: "PhotoGenius AI terms of service — rules and conditions for using our platform.",
}
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-invert prose-zinc max-w-none space-y-8 text-zinc-300">
            <section>
              ...
              <p className="leading-relaxed">By accessing or using PhotoGenius AI (“Service”), you agree to these Terms of Service. If you do not agree, do not use the Service.</p>
            </section>
            <section>
            ...
            <p className="text-zinc-400 text-sm pt-4">Questions? Contact us at <a href="mailto:legal@photogenius.ai" className="text-purple-400 hover:underline">legal@photogenius.ai</a> or via the <Link href="/contact" className="text-purple-400 hover:underline">Contact</Link> page.</p>
          </div>
        </div>
      </main>
