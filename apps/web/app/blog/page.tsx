...
const POSTS = [
  { slug: "getting-started", title: "Getting Started with AI Image Generation", date: "Feb 2026", excerpt: "Learn how to create your first images with simple prompts and get the best results." },
  { slug: "prompt-tips", title: "Prompt Tips for Better Results", date: "Jan 2026", excerpt: "Write prompts that get you professional-quality images every time." },
  { slug: "styles-and-modes", title: "Styles & Creative Modes", date: "Jan 2026", excerpt: "Explore portraits, anime, cinematic, and more — pick the right mode for your idea." },
]
    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <main className="pt-28 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-zinc-400 mb-12">Tips, updates, and inspiration for creating with Pixium AI.</p>

          <div className="space-y-6">
            {POSTS.map((post) => (
              <article key={post.slug} className="p-6 rounded-2xl bg-zinc-900/50 border border-white/[0.08] hover:border-white/15 transition-colors">
                <p className="text-sm text-zinc-500 mb-2">{post.date}</p>
                <h2 className="text-xl font-semibold text-white mb-2">{post.title}</h2>
                <p className="text-zinc-400 mb-4">{post.excerpt}</p>
                <Link href="#" className="inline-flex items-center gap-2 text-sm font-medium text-purple-400 hover:text-purple-300 transition-colors">
