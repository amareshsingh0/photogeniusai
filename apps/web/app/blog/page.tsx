...
export const metadata = {
  title: "Blog | PhotoGenius AI",
  description: "Tips, updates, and inspiration for AI image generation with PhotoGenius.",
}
    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <main className="pt-28 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-zinc-400 mb-12">Tips, updates, and inspiration for creating with PhotoGenius AI.</p>
