        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-invert prose-zinc max-w-none space-y-8 text-zinc-300">
            ...
            <section>
              ...
              <p className="leading-relaxed">We use your information to provide and improve Pixium AI, to process generations, to communicate with you, to enforce our terms, and to comply with law. We do not sell your personal information to third parties.</p>
            </section>
            <section>
            ...
            <p className="text-zinc-400 text-sm pt-4">For questions about this Privacy Policy, contact us at <a href="mailto:privacy@pixium.ai" className="text-purple-400 hover:underline">privacy@pixium.ai</a> or via the <Link href="/contact" className="text-purple-400 hover:underline">Contact</Link> page.</p>
          </div>
        </div>
      </main>
