...
export const metadata = {
  title: "Contact | PhotoGenius AI",
  description: "Get in touch with the PhotoGenius AI team for support, partnerships, or feedback.",
}
      ...
      <main className="pt-28 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-12">
            <a href="mailto:support@photogenius.ai" className="flex items-start gap-4 p-6 rounded-2xl bg-zinc-900/50 border border-white/[0.08] hover:border-purple-500/30 transition-colors">
              ...
              <div>
                ...
                <span className="text-purple-400 text-sm">support@photogenius.ai</span>
              </div>
            </a>
