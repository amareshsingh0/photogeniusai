    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <main className="pt-28 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-zinc-400 mb-12">Have a question or feedback? We’d love to hear from you.</p>

          <div className="grid sm:grid-cols-2 gap-6 mb-12">
            <a href="mailto:support@pixium.ai" className="flex items-start gap-4 p-6 rounded-2xl bg-zinc-900/50 border border-white/[0.08] hover:border-purple-500/30 transition-colors">
              <div className="p-3 rounded-xl bg-purple-500/10">
                <Mail className="h-6 w-6 text-purple-400" />
              </div>
              <div>
                <h2 className="font-semibold text-white mb-1">Email</h2>
                <p className="text-sm text-zinc-400 mb-1">Support & general inquiries</p>
                <span className="text-purple-400 text-sm">support@pixium.ai</span>
              </div>
            </a>
            <a href="#" className="flex items-start gap-4 p-6 rounded-2xl bg-zinc-900/50 border border-white/[0.08] hover:border-purple-500/30 transition-colors">
              <div className="p-3 rounded-xl bg-purple-500/10">
                <MessageSquare className="h-6 w-6 text-purple-400" />
              </div>
              <div>
                <h2 className="font-semibold text-white mb-1">Community</h2>
                <p className="text-sm text-zinc-400 mb-1">Discord & social</p>
                <span className="text-purple-400 text-sm">Join our Discord</span>
              </div>
            </a>
          </div>

          <div className="p-6 rounded-2xl bg-zinc-900/30 border border-white/[0.06]">
            <h2 className="font-semibold text-white mb-2">Response time</h2>
            <p className="text-zinc-400 text-sm">We typically respond within 1–2 business days. For urgent issues, mention “Urgent” in your subject line.</p>
          </div>
        </div>
      </main>
