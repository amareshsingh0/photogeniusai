...
function Hero() {
  ...
  return (
    <section className="relative -mt-20 min-h-[72vh] overflow-hidden sm:min-h-[78vh] lg:min-h-[88vh]">
      ...
      {/* Foreground */}
      <div className="relative z-10 mx-auto flex min-h-[72vh] max-w-3xl flex-col items-center justify-center px-4 pt-24 pb-10 text-center sm:min-h-[78vh] sm:pt-24 sm:pb-12 lg:min-h-[88vh] lg:pt-28 lg:pb-16">
...
function LivingWall() {
  ...
  return (
    <>
      ...
      <div
        className="pointer-events-none absolute inset-0 grid grid-cols-2 gap-2 overflow-hidden p-2 sm:grid-cols-3 sm:gap-3 sm:p-3 md:grid-cols-4 lg:grid-cols-6"
        ...
        {cols.map((col, ci) => {
          ...
          return (
            <div
              key={ci}
              className={`relative ${
                ci === 2 ? "hidden sm:block" :       // col 2 visible from sm (3-col grid)
                ci === 3 ? "hidden md:block" :       // col 3 visible from md (4-col grid)
                ci > 3   ? "hidden lg:block" : ""    // cols 4,5 visible from lg (6-col grid)
              }`}
            >
              <div
