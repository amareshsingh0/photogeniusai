...
export const metadata = {
  title: "About | PhotoGenius AI",
  description: "Learn about PhotoGenius AI — our mission, team, and how we help you turn imagination into stunning images.",
}
    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <main className="pt-28 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">About PhotoGenius AI</h1>
          ...
          <div className="space-y-10 text-zinc-300 leading-relaxed">
            <p>
              PhotoGenius AI is an AI-powered image generation platform. Describe what you imagine — portraits, anime, architecture, products, or fantasy scenes — and get stunning, print-ready results without design skills.
            </p>
            <p>
              We built PhotoGenius to make professional visual creation accessible. Whether you need headshots, marketing visuals, or creative art, our AI understands your intent and delivers consistent, high-quality images.
            </p>
          </div>
