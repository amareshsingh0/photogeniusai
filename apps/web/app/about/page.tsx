...
export const metadata = {
  ...
  description: "Learn about Pixium AI — our mission, team, and how we help you turn imagination into stunning images.",
}
    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <main className="pt-28 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">About Pixium AI</h1>
          <p className="text-xl text-zinc-400 mb-12">We help anyone turn ideas into professional-quality images in seconds.</p>

          <div className="space-y-10 text-zinc-300 leading-relaxed">
            <p>
              Pixium AI is an AI-powered image generation platform. Describe what you imagine — portraits, anime, architecture, products, or fantasy scenes — and get stunning, print-ready results without design skills.
            </p>
            <p>
              We built Pixium to make professional visual creation accessible. Whether you need headshots, marketing visuals, or creative art, our AI understands your intent and delivers consistent, high-quality images.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-6 mt-16">
            <div className="p-6 rounded-2xl bg-zinc-900/50 border border-white/[0.08]">
              ...
              <h2 className="font-semibold text-white mb-2">Our Mission</h2>
              <p className="text-sm text-zinc-400">Democratize professional image creation with simple descriptions and AI.</p>
            </div>
            <div className="p-6 rounded-2xl bg-zinc-900/50 border border-white/[0.08]">
              <Heart className="h-8 w-8 text-purple-400 mb-3" />
              <h2 className="font-semibold text-white mb-2">For Everyone</h2>
              <p className="text-sm text-zinc-400">Creators, marketers, and teams — no design experience required.</p>
            </div>
            <div className="p-6 rounded-2xl bg-zinc-900/50 border border-white/[0.08]">
              <Zap className="h-8 w-8 text-purple-400 mb-3" />
              <h2 className="font-semibold text-white mb-2">Fast & Simple</h2>
              <p className="text-sm text-zinc-400">Describe, generate, and download in seconds.</p>
            </div>
          </div>
        </div>
      </main>
