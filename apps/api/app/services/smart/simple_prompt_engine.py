...
_BUCKET_HINTS = {
    ...
    "vector": (
        ...
        "washed-out beige minimalism, NOT cold corporate gray.\n"
        ...
        "B&W-first composition. NOT a scene. `ad_copy` is EMPTY for pure symbols; for "
        "wordmarks/combinations set `ad_copy.headline` to the literal brand text only. The "
        "`prompt` reads like a senior brand designer's brief, not a generic image prompt. If "
        "the request is NOT a logo (flat illustration, sticker, infographic, icon set), "
        "ignore Phases 1/4/5 and just specify shapes, palette, geometry, no photo realism."
    ),
